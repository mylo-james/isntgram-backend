...
def register():
    ...
    try:
        ...
        user_dict['numFollowing'] = num_following
        user_dict['numFollowers'] = num_followers
        access_token=jwt.encode({'email': user.email}, Configuration.SECRET_KEY, algorithms="HS256")
...
def logout():
    access_token=jwt.encode({'email': ''}, Configuration.SECRET_KEY, algorithm="HS256")
